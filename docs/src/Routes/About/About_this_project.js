...
export const About_this_project = () =>
    <div>
        <h2 style={{textAlign: 'center'}}>About</h2>
        <div>
            <p>
                In 2017 I finished (successfully) my studies of computer science. Enjoying Python,
                being a fan of Martin Fowler and Uncle Bob, favoring functional programming,
                I have innocently become a <em>front end developer</em> and felt pretty much like&nbsp;
                <a href="https://hackernoon.com/how-it-feels-to-learn-javascript-in-2016-d3a717dd577f">this guy</a>.
            </p>
            <p>
